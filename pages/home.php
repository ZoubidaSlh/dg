...
if(isset($_SESSION["connexion"])){
	...
	?>
	<a class="waves-effect waves-light" id="btn" href="javascript:;" onclick="$.Notification.notify('success','top left', 'Bienvenue ', ' ')">error</a>
	<?php
}
?>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <p class="text-muted page-title-alt">Bienvenue à votre tableau de board !</p>
                            </div>
                        </div>
